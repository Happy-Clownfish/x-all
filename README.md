xray vmess vless trojan shadowsocks socks tor  
...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/Happy-Clownfish/x-all)  
...
* **务必替换所有的b8439b14-c0e4-406f-a609-01a7ef6316e7为部署时设置的AUUID**  
...
* 端口：443
* 默认UUID：b8439b14-c0e4-406f-a609-01a7ef6316e7
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 路径：/b8439b14-c0e4-406f-a609-01a7ef6316e7-vless // 默认vless使用/$uuid-vless，vmess使用/$uuid-vmess
* 底层传输安全：tls
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "b8439b14-c0e4-406f-a609-01a7ef6316e7"
    ],
    "websocket": {
        "enabled": true,
        "path": "/b8439b14-c0e4-406f-a609-01a7ef6316e7-trojan",
...
* 插件选项: tls;host=appname.herokuapp.com;path=/b8439b14-c0e4-406f-a609-01a7ef6316e7-ss
```
</details>
